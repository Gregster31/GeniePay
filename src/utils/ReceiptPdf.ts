    ...
    .map(
      ...
      <tr>
        ...
        <td style="padding:10px 12px;border-bottom:1px solid #2a2438;color:#9ca3af;font-size:13px;text-align:right;">
          ${r.amountEth !== undefined ? `${r.amountEth.toFixed(6)} ${receipt.currency}` : '—'}
        </td>
      </tr>`,
    )
    .join('');
  ...
  <div class="card">
    ...
    <div class="amount-row">
      <div>
        ...
        <div class="amount-sub">${receipt.totalCrypto.toFixed(6)} ${receipt.currency} on ${receipt.network}</div>
      </div>
    ...
    <div class="meta-grid">
      ...
      <div class="meta-item">
        ...
        <div class="value">${receipt.network}</div>
      </div>
      <div class="meta-item">
      ...
      ${receipt.gasFee ? `<div class="meta-item"><div class="label">Gas Used</div><div class="value">${receipt.gasFee}</div></div>` : ''}
    </div>
    ...
    <div class="footer">
      <span>Generated by GeniePay · geniepay.app</span>
